...
_(Detailed analysis is in PREFETCH_ANALYSIS.md; below is a short reference.)_
...
_This document is analysis and suggestion only; no production code was modified._
