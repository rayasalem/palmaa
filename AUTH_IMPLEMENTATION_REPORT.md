...
- **SMTP:** Replace EMAIL\_\* in `.env` with real credentials (e.g. Gmail app password) to send live emails; otherwise registration/forgot-password will fail to send and log "Email not configured" or send errors.
