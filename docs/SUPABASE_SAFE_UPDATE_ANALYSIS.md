...
| **تسريب Service Role**        | من يملك المفتاح يصل لكل الجداول ويتجاوز RLS                                     | عدم وضع Service Role في الفرونت إند أو في متغيرات VITE\_\*؛ الاحتفاظ به في متغيرات بيئة الخادم فقط |
...
_تم إعداد هذا التحليل دون تعديل أي كود في المشروع؛ وهو للمرجعية والتخطيط فقط._
