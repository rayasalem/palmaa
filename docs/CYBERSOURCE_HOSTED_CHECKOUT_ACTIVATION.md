...
## الخطوة 5: إعداد صفحة استجابة الزبون (Customer Response Page)
...
4. **Customer Redirect after Checkout:**  
   أدخل الرابط الذي يُعاد إليه الزبون بعد انتهاء الدفع، مثلاً:
...
حتى يستلم السيرفر نتيجة المعاملة حتى لو أغلق الزبون المتصفح:
