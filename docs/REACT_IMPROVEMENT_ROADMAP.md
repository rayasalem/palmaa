...
_Low-risk, high-value: documentation, dependency checks, and verification._
...
_Focus on re-renders, bundle size, and runtime performance—verify first, then plan._
...
_Longer-term: state shape, testing, and structure—design only._
