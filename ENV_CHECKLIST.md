...
| ---------------- | --------------------- | ---------------------------------------------------------------------- |
| محلي – باكند     | `server/.env`         | SUPABASE\_\*, JWT_SECRET, FRONTEND_URL, RESEND_API_KEY, RESEND_FROM    |
| محلي – فرونت     | `.env` (جذر المشروع)  | VITE*SUPABASE*_, VITE*CLOUDINARY*_                                     |
| السيرفر (Render) | Environment Variables | نفس متغيرات الباكند (SUPABASE*\*, JWT_SECRET, FRONTEND_URL, RESEND*\*) |
