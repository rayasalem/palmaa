...
const Logo: React.FC<LogoProps> = ({
  ...
  return (
    <div className={`flex items-center gap-2 sm:gap-3 ${className}`}>
            ...
            >
              <g transform="translate(0, 2)">
                <path
                  ...
                  strokeWidth="0.5"
                />
                <path d="M14 8v-2c0-2 1.5-4 4-4h12c2.5 0 4 2 4 4v2" fill="none" stroke={primaryRed} strokeWidth="1.5" strokeLinecap="round" />
                <text x="23" y="32" fill={white} fontSize="18" fontWeight="800" fontFamily="system-ui, sans-serif" textAnchor="middle">P</text>
              </g>
              <text x="48" y="32" fill={primaryRed} fontSize="22" fontWeight="800" fontFamily="system-ui, sans-serif">A</text>
              <g fill={theme === 'light' ? darkGray : 'rgba(255,255,255,0.9)'}>
                <text x="72" y="32" fontSize="22" fontWeight="700" fontFamily="system-ui, sans-serif">L</text>
                <line x1="72" y1="34" x2="82" y2="34" stroke="currentColor" strokeWidth="0.8" opacity="0.7" />
                <text x="88" y="32" fontSize="22" fontWeight="700" fontFamily="system-ui, sans-serif">M</text>
                <line x1="88" y1="34" x2="102" y2="34" stroke="currentColor" strokeWidth="0.8" opacity="0.7" />
                <text x="108" y="32" fontSize="22" fontWeight="700" fontFamily="system-ui, sans-serif">A</text>
              </g>
              ...
              <g transform="translate(52, 52)">
                ...
                <text x="7" y="8" fill={white} fontSize="7" fontWeight="800" fontFamily="system-ui, sans-serif" textAnchor="middle">$</text>
              </g>
            </svg>
          )}
        </>
      ...
      {showText && (
        <span className={`text-[10px] font-bold uppercase tracking-[0.2em] opacity-90 self-center ${theme === 'light' ? 'text-palma-muted' : 'text-white/80'}`}>
          Marketplace
        </span>
      )}
    </div>
