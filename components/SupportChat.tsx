...
/** خيارات سريعة للأسئلة المتوقعة (زائر/عميل/تاجر/أدمن) — النص يُرسل كسؤال ويُطابق الرد المناسب */
...
const CHAT_TEXTS: Record<Language, { title: string; placeholder: string; send: string; welcome: string; contactHint: string; quickOptionsTitle?: string; faq: Record<string, string> }> = {
  ar: {
    ...
    roleLabel: { customer: 'عميل', merchant: 'تاجر', admin: 'أدمن', broker: 'وسيط', guest: 'زائر' },
    roleIntro: { CUSTOMER: 'بما أنك عميل، ', MERCHANT: 'بما أنك تاجر، ', ADMIN: 'بما أنك أدمن، ', BROKER: 'بما أنك وسيط، ' },
    faq: {
      ...
      register: 'إنشاء حساب: 1) اضغط "إنشاء حساب" أو "انضم" 2) اختر نوع الحساب (عميل، تاجر، أو وسيط) 3) أدخل البيانات المطلوبة 4) فعّل الحساب عبر البريد إن طُلب منك ذلك.',
      ...
      manageOrders: 'إدارة الطلبات: • كعميل: من القائمة اختر "طلباتي" لعرض وتتبع طلباتك. • كتاجر: لوحة التحكم ← الطلبات لعرض طلبات المتجر وتحديث الحالة. • كأدمن: لوحة التحكم ← الطلبات لإدارة كل الطلبات على المنصة.',
