...
const ar = {
  common: {
    ...
    showMore: 'عرض المزيد',
    groupFood: 'مواد غذائية',
    groupFashion: 'الأزياء',
    groupElectronics: 'الإلكترونيات',
    groupHome: 'المنزل',
    groupKids: 'الأطفال',
    groupAutomotive: 'السيارات',
    groupPersonalCare: 'العناية الشخصية',
    groupServices: 'خدمات',
    close: 'إغلاق',
    active: 'نشط',
    inactive: 'غير نشط',
    ...
    specificProducts: 'منتجات معينة',
    resetFilters: 'إعادة تعيين',
    clickAgainToClearFilter: 'اضغط على الخيار مرة ثانية لإلغاء الفلتر',
  ...
  categories: {
    ...
    oils_sauces: 'زيوت وصلصات',
    frozen_food: 'أطعمة مجمدة',
    phones: 'هواتف',
    computers: 'حواسيب',
    electronics_accessories: 'إكسسوارات إلكترونية',
    ...
    traditional_wear: 'ملابس تقليدية',
    furniture: 'أثاث',
    kitchen: 'أدوات مطبخ',
    home_decor: 'ديكور منزلي',
    garden: 'حديقة ونباتات',
    tools: 'عدد وأدوات',
...
const en = {
  ...
  common: {
    ...
    showMore: 'Show more',
    groupFood: 'Food & Groceries',
    groupFashion: 'Fashion',
    groupElectronics: 'Electronics',
    groupHome: 'Home',
    groupKids: 'Kids',
    groupAutomotive: 'Automotive',
    groupPersonalCare: 'Personal care',
    groupServices: 'Services',
    clickAgainToClearFilter: 'Click the same option again to clear the filter',
    details: 'Details',
...
const he = {
  ...
  common: {
    ...
    searchCategoryPlaceholder: 'חפש קטגוריה...',
    mostOrdered: 'הכי מבוקשים',
    showMore: 'הצג עוד',
    groupFood: 'מזון',
    groupFashion: 'אופנה',
    groupElectronics: 'אלקטרוניקה',
    groupHome: 'בית',
    groupKids: 'ילדים',
    groupAutomotive: 'רכב',
    groupPersonalCare: 'טיפוח',
    ...
    resetFilters: 'איפוס',
    clickAgainToClearFilter: 'לחץ שוב כדי לבטל את המסנן',
  ...
  categories: {
    ...
    water: 'מים',
    dairy_drinks: 'משקאות חלב',
    fruits: 'פירות',
    vegetables: 'ירקות',
    dairy: 'חלב וגבינות',
    bakery: 'מאפייה',
    meat_poultry: 'בשר ועופות',
    canned_food: 'שימורים',
    snacks: 'חטיפים',
    sweets: 'ממתקים',
    spices: 'תבלינים',
    grains: 'דגנים וקטניות',
    ready_meals: 'ארוחות מוכנות',
    oils_sauces: 'שמנים ורטבים',
    frozen_food: 'מזון קפוא',
    phones: 'טלפונים',
    computers: 'מחשבים',
    electronics_accessories: 'אביזרי אלקטרוניקה',
    home_appliances: 'מכשירי חשמל',
    cameras: 'מצלמות',
    gaming: 'משחקים',
    men_clothing: 'בגדי גברים',
    women_clothing: 'בגדי נשים',
    kids_clothing: 'בגדי ילדים',
    shoes: 'נעליים',
    bags_accessories: 'תיקים ואקססוריז',
    traditional_wear: 'לבוש מסורתי',
    furniture: 'ריהוט',
    kitchen: 'כלי מטבח',
    home_decor: 'עיצוב הבית',
    garden: 'גן וצמחים',
    tools: 'כלים וחומרה',
    skincare: 'טיפוח העור',
    makeup: 'איפור',
...
/** نوع كائن الترجمة (يُستخدم في props المكونات) */
export type TranslationRecord = typeof ar;
